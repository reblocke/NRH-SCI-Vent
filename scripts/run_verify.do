* Batch adapter for verify launchers. Stata for macOS may return process status
...
args repo_root status_file output_root run_id
...
if _rc {
    ...
    capture noisily do run_all.do verify ///
        "" "`output_root'" "`run_id'"
